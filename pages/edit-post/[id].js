...
function EditPost() {
    ...
    return(
        <div className="text-3xl font-semibold tracking-wide mt-6 mb-2">
            Edit Post
        {
            coverImage && (
        ...
        <button className="mb-4 bg-purple-6 00 text-white font-semibold px-8 py-2 rounded-lg"
            onClick={uploadImage}
        >UPload cover image</button>
        <button className="mb-4 bg-blue-6 00 text-white font-semibold px-8 py-2 rounded-lg"
